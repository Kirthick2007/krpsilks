...
export default function KanchipuramSilks() {
  const collection = collections.find((c) => c.slug === "kanchipuram-silks");
      ...
      <section className="coll-detail">
        <div className="container grid">
          ...
          <div className="reveal reveal-delay-1">
            <span className="eyebrow">Kanchipuram Silks</span>
            <h2>The Signature Weave</h2>
            ...
            <div className="cta-row">
              <a
                className="btn solid"
                href={whatsappUrl(
                  "Hello KRPSILKS, I would like to know more about your Kanchipuram Silks collection."
                )}
                target="_blank"
